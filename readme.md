...
![Screenshot of FR24 card in action](readme/images/fr24card.png?raw=true "Screenshot of FR24 card in action")
...
| `sort`           | `string`  | `distance`                                                                     | Any column, see [columns](#columns)                                 | The data in the table is by default sorted on the calculated distance, with this option you can set a different column, for example `flight`.                                                                                                                                                                                                                                                                                                                                    |
